...
cagroup3nonsong <- classifymulti(group3nonsong1657, control, "group3nonsong1657", 10)
saveRDS(cagroup3nonsong, file = "caroup3nonsong1657multi.rds")
cagroup3nonsong1287 <- classifymulti(group3nonsong1287, control, "group3nonsong1287", 10)
saveRDS(cagroup3nonsong1287, file = "caroup3nonsong1287multi.rds")
cagroup3nonsongunbalan <- classifymulti(group3nonsongunbalan, control, "group3nonsongunbalan", 10)
saveRDS(cagroup3nonsongunbalan, file = "cagroup3nonsongunbalanmulti.rds")
...
cagroup3dedupbalan <- classifymulti(dedupngroup3balan, control, "1287", 10)
saveRDS(cagroup3dedupbalan, file = "cagroup3multi1287.rds")
