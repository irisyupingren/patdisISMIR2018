...
algcoor1657.1 <- sample_n(algcoor, 1657)
algcoor1657.2 <- sample_n(algcoor, 1657)
algcoor1657.3 <- sample_n(algcoor, 1657)
algcoor1657.4 <- sample_n(algcoor, 1657)
algcoor1657.5 <- sample_n(algcoor, 1657)
algcoor1657 <- sample_n(bind_rows(algcoor1657.1,algcoor1657.2,algcoor1657.3,algcoor1657.4,algcoor1657.5), 1657)
algcoor1657$id <- NULL
...
coorgroup355 <- bind_rows(siafcoor355, siapcoor355, siarcoor355, vm2coor355, vmcoor355, mpcoor355, scfpcoor355, noncoor355, patcoor355,.id="id")
